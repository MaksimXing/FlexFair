...
for site in sites:
    ...
    # Step 2: Identify and read mask images from the folder
    image_files = [file for file in os.listdir(image_dir) if file.endswith(('.png', '.bmp', '.jpg', '.jpeg'))]
    # Only consider mask files assuming masks end with '_label'
...
print("Data saved successfully to 'histogram_data.pkl'.")
