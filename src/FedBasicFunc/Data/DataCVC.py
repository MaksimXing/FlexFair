...
class DataCVC(Dataset):
    def __init__(self, args):
        self.args = args
        self.samples = [name for name in os.listdir(args.datapath+'Public_5/train/image/site_CVC')]
    ...
    def __getitem__(self, idx):
        ...
        image = cv2.imread(self.args.datapath+'Public_5/train/image/site_CVC/'+name)
        ...
        mask  = cv2.imread(self.args.datapath+'Public_5/train/mask/site_CVC/'+name, cv2.IMREAD_GRAYSCALE)/255.0
