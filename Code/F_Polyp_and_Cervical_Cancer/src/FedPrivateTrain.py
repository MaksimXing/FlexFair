...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_private_dataset', type=int, default=1)
    parser.add_argument('--shengfuyou', type=bool, default=True)
    parser.add_argument('--newzhongda', type=bool, default=True)
    parser.add_argument('--newzhongzhong', type=bool, default=True)
    parser.add_argument('--newzhongyi', type=bool, default=True)
    
    parser.add_argument('--use_public_dataset', type=int, default=0)
    parser.add_argument('--cvc', type=bool, default=False)
    parser.add_argument('--kva', type=bool, default=False)
    ...
    parser.add_argument('--epoch', default=52)
    parser.add_argument('--com_round', type=int, default=3, help='number of maximum communication round')
    ...
    if args.method == 'fedavg':
        ...
        args.use_weight = 1
        args.fairness_step = 28  
        args.batch_size = 64
        weight = args.penalty_weight
    
    args.savepath = f'../output/private/{args.method}/s{seed}_w{weight}/'
    t = Train(args)
    t.train()
