...
def ResNet50():
    return ResNet([3, 4, 6, 3], '../pretrain/resnet50-19c8e357.pth')

def ResNet101():
    return ResNet([3, 4, 23, 3], '../pretrain/resnet101-5d3b4d8f.pth')

def ResNet152():
    return ResNet([3, 8, 36, 3], '../pretrain/resnet152-b121ed2d.pth')