...
class FairMixupTrainPublic(object):
    def __init__(self, DataList, FairMixupModel, args):
        ...
        model_state_dict = torch.load(f'../res/public/avg{self.args.seed}_model')
            ...
            for loader_model_index in range(self.args.site_num):
                ...
                for image, mask in self.loader_list[loader_model_index]:
                    ...
                    try:
                        ...
                        # reg on grad
                        for ii, batch_x in enumerate(batch_x_mix):
                            batch_x = batch_x_mix[ii]
                            # reg loss
                            # print(batch_x.shape)
                            ...
                            batch_x_d = batch_x - [batch_x1, batch_x2][loader_model_index]
