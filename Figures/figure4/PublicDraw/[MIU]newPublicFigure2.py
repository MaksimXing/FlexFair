...
gap_valve = 0.878  # Set Dice Valve

paths_ = [f'your_path_on_result_public/FedProx-miu/seed0',
          f'your_path_on_result_public/Scaffold-miu/seed0',
          f'your_path_on_result_public/FedNova-miu/seed0',
          f'your_path_on_result_public/fairmixup_step2/seed0',
          f'your_path_on_result_public/fairfed/seed0',
          f'your_path_on_result_public/FedAvg_OOD/seed0']
...
for seed in seeds:
    pick_num = 10
    global_file = f'your_path_on_result_public/FedAvg/seed{seed}/global.csv'
