...
class FairFedTrainPublic(object):
        ...
        for epoch in range(self.args.epoch):
            ...
            if com_counter == 0:
                if self.args.is_same_initial:
                    ...
                    ratio = [dataset_size[index] * 1.0 / dataset_total_size for index in range(self.args.site_num)]
            ...
            # for every epoch, every sub model run once
                ...
                client_gaps = []
                for model_index in range(self.args.site_num):
                    mean_dice = RunFedTestKVA_CVC_client(self.sub_model_list[model_index],
                                                     self.args, cur_model_path, epoch) 
                    
                    client_gaps.append(abs(ret_0[0] - mean_dice[loader_model_index]))
